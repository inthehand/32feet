...
interface IOBluetoothDevice : INSCoding, INSSecureCoding
{
	...
	unsafe IOBluetoothDevice DeviceWithAddress (BluetoothDeviceAddress* address);
	...
	unsafe int SendL2CAPEchoRequest (void* data, ushort length);
	...
	[Export ("getAddress")]
	unsafe BluetoothDeviceAddress* Address { get; }
...
interface IOBluetoothDevicePair
{
	...
	unsafe void ReplyPINCode (nuint PINCodeSize, BluetoothPINCode* PINCode);
...
interface IOBluetoothL2CAPChannel : INSPortDelegate
{
	...
	IOBluetoothUserNotification RegisterForChannelOpenNotifications (NSObject @object, Selector selector, ushort psm, IOBluetoothUserNotificationChannelDirection inDirection);
	...
	unsafe int WriteAsync (void* data, ushort length, void* refcon);

	// -(IOReturn)writeSync:(void *)data length:(UInt16)length;
	[Export ("writeSync:length:")]
	unsafe int WriteSync (void* data, ushort length);
...
interface IOBluetoothL2CAPChannelDelegate
{
	...
	unsafe void L2capChannelData (IOBluetoothL2CAPChannel l2capChannel, void* dataPointer, nuint dataLength);
	...
	unsafe void L2capChannelWriteComplete (IOBluetoothL2CAPChannel l2capChannel, void* refcon, int error);
...
interface IOBluetoothRFCOMMChannel : INSPortDelegate
{
	...
	IOBluetoothUserNotification RegisterForChannelOpenNotifications (NSObject @object, Selector selector, byte channelID, IOBluetoothUserNotificationChannelDirection inDirection);
	...
	int SendRemoteLineStatus (BluetoothRFCOMMLineStatus lineStatus);
...
interface IOBluetoothRFCOMMChannelDelegate
{
	...
	unsafe void RfcommChannelData (IOBluetoothRFCOMMChannel rfcommChannel, void* dataPointer, nuint dataLength);
	...
	unsafe void RfcommChannelWriteComplete (IOBluetoothRFCOMMChannel rfcommChannel, void* refcon, int error);
...
interface IOBluetoothSDPUUID
{
	...
	unsafe IOBluetoothSDPUUID UuidWithBytes (void* bytes, uint length);
...
interface OBEXSession
{
	...
	unsafe int OBEXConnect (byte inFlags, ushort inMaxPacketLength, void* inOptionalHeaders, nuint inOptionalHeadersLength, Selector inSelector, NSObject inTarget, void* inUserRefCon);
	...
	unsafe int OBEXDisconnect (void* inOptionalHeaders, nuint inOptionalHeadersLength, Selector inSelector, NSObject inTarget, void* inUserRefCon);
	...
	unsafe int OBEXPut (byte isFinalChunk, void* inHeadersData, nuint inHeadersDataLength, void* inBodyData, nuint inBodyDataLength, Selector inSelector, NSObject inTarget, void* inUserRefCon);
	...
	unsafe int OBEXGet (byte isFinalChunk, void* inHeaders, nuint inHeadersLength, Selector inSelector, NSObject inTarget, void* inUserRefCon);
	...
	unsafe int OBEXAbort (void* inOptionalHeaders, nuint inOptionalHeadersLength, Selector inSelector, NSObject inTarget, void* inUserRefCon);
	...
	unsafe int OBEXSetPath (byte inFlags, byte inConstants, void* inOptionalHeaders, nuint inOptionalHeadersLength, Selector inSelector, NSObject inTarget, void* inUserRefCon);
	...
	unsafe int OBEXConnectResponse (byte inResponseOpCode, byte inFlags, ushort inMaxPacketLength, void* inOptionalHeaders, nuint inOptionalHeadersLength, Selector inSelector, NSObject inTarget, void* inUserRefCon);
	...
	unsafe int OBEXDisconnectResponse (byte inResponseOpCode, void* inOptionalHeaders, nuint inOptionalHeadersLength, Selector inSelector, NSObject inTarget, void* inUserRefCon);
	...
	unsafe int OBEXPutResponse (byte inResponseOpCode, void* inOptionalHeaders, nuint inOptionalHeadersLength, Selector inSelector, NSObject inTarget, void* inUserRefCon);
	...
	unsafe int OBEXGetResponse (byte inResponseOpCode, void* inOptionalHeaders, nuint inOptionalHeadersLength, Selector inSelector, NSObject inTarget, void* inUserRefCon);
	...
	unsafe int OBEXAbortResponse (byte inResponseOpCode, void* inOptionalHeaders, nuint inOptionalHeadersLength, Selector inSelector, NSObject inTarget, void* inUserRefCon);
	...
	unsafe int OBEXSetPathResponse (byte inResponseOpCode, void* inOptionalHeaders, nuint inOptionalHeadersLength, Selector inSelector, NSObject inTarget, void* inUserRefCon);
	...
	unsafe void SetEventRefCon (void* inRefCon);
	...
	unsafe int SendDataToTransport (void* inDataToSend, nuint inDataLength);
	...
	unsafe int OpenTransportConnection (Selector inSelector, NSObject inTarget, void* inUserRefCon);
...
interface IOBluetoothOBEXSession : IOBluetoothRFCOMMChannelDelegate
{
	...
	unsafe IOBluetoothOBEXSession WithIncomingRFCOMMChannel (IOBluetoothRFCOMMChannel inChannel, Selector inEventSelector, NSObject inEventSelectorTarget, void* inUserRefCon);
	...
	unsafe IntPtr Constructor (IOBluetoothRFCOMMChannel inChannel, Selector inEventSelector, NSObject inEventSelectorTarget, void* inUserRefCon);
...
interface NSMutableDictionary_NSDictionaryOBEXExtensions
{
	...
	unsafe NSMutableDictionary DictionaryWithOBEXHeadersData (void* inHeadersData, nuint inDataSize);
