...
namespace InTheHand.Net.Sockets
{
    ...
    public class IrDAClient : IDisposable
	{
		...
		public IrDAClient()
		{
            Client = new Socket(AddressFamily.Irda, SocketType.Stream, ProtocolType.IP);
		}
        ...
        /// </code>
        /// </example>
        public Socket Client { [System.Diagnostics.DebuggerStepThrough]  get; set; }
		...
		{
            EnsureNotDisposed();
            return DiscoverDevices(8, Client);
		}
		...
		{
            EnsureNotDisposed();
            return DiscoverDevices(maxDevices, Client);
		}
		...
		public static IrDADeviceInfo[] DiscoverDevices(int maxDevices, Socket irdaSocket)
		{
            ...
            const int MaxItemsInHugeBuffer = (int.MaxValue - 4) / 32;
        ...
        public static string GetRemoteMachineName(Socket irdaSocket)
		{
            ...
            throw new ArgumentOutOfRangeException(nameof(irdaSocket), "No matching device discovered.");
		}
        ...
        public string RemoteMachineName
		{
			...
			{
                EnsureNotDisposed();
				return GetRemoteMachineName(Client);
			}
        }
        ...
        public NetworkStream GetStream()
        {
            ...
            if (dataStream == null)
            {
                dataStream = new NetworkStream(Client, true);
            }
        ...
        {
            Debug.Assert(cleanedUp == (Client == null), "always consistent!! ("
                + cleanedUp + " != " + (Client == null) + ")");
            if (cleanedUp || (Client == null))
