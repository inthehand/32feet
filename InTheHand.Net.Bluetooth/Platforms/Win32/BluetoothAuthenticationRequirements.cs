...
//
// InTheHand.Net.Bluetooth.BluetoothAuthenticationRequirements
// 
...
namespace InTheHand.Net.Bluetooth
{
    ...
    internal enum BluetoothAuthenticationRequirements : int // MSFT+Win32 AUTHENTICATION_REQUIREMENTS
    {
        /// <summary>
